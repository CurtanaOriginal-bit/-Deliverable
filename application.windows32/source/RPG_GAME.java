...
public class RPG_GAME extends PApplet {
  ...
  if (System == true) {
    ...
    if (menuTime >= 0 && menuTime <= 900) {
      ...
      if (atack[0] == true) {
        ...
        fill(255, 0, 0);
        text(PApplet.parseInt(atackDamage[0] / 2) - Boss[1], width / 2 + 50, dy1);
      }
      if (gard[0] == true) {
      ...
      if (skillAtackReimu[0] == true) {
        ...
        fill(255, 0, 0);
        text((((18 + PApplet.parseInt(atackDamage[0] * 0.6f)) * (((char1[5] * 1) + 100) / 100)) / 2) - Boss[1], width / 2 + 50, dy1);
      }

      if (skillAtackReimu[1] == true) {
        text(ReimuSkill[1], width / 2 - textWidth(ReimuSkill[0]) / 2, 78);
        fill(255, 0, 0);
        text((((70 + PApplet.parseInt(atackDamage[0] * 0.6f)) * (((char1[5] * 1) + 100) / 100)) / 2) - Boss[1], width / 2 + 50, dy1);
      }
      if (skillAtackReimu[2] == true) {
        text(ReimuSkill[2], width / 2 - textWidth(ReimuSkill[0]) / 2, 78);
        fill(255, 0, 0);
        text((((160 + PApplet.parseInt(atackDamage[0] * 0.6f)) * (((char1[5] * 1) + 100) / 100)) / 2) - Boss[1], width / 2 + 50, dy1);
      }
    ...
    if (menuTime >= 500 && One3 == true) {
      if (atack[0] == true) {
        punch.trigger();
        Boss[0] = Boss[0] - (PApplet.parseInt(atackDamage[0] / 2) - Boss[1]);
      }
      if (gard[0] == true) {
        char1[3] *= 2;
      }
      ...
      if (skillAtackReimu[0] == true) {
        skill.trigger();
        Boss[0] = Boss[0] - ((((18 + PApplet.parseInt(atackDamage[0] * 0.6f)) * (((char1[5] * 1) + 100) / 100)) / 2) - Boss[1]);
        char1St[1] -= 8;
      }
      if (skillAtackReimu[1] == true) {
        skill.trigger();
        Boss[0] = Boss[0] - ((((70 + PApplet.parseInt(atackDamage[0] * 0.6f)) * (((char1[5] * 1) + 100) / 100)) / 2) - Boss[1]);
        char1St[1] -= 18;
      }
      if (skillAtackReimu[2] == true) {
        skill.trigger();
        Boss[0] = Boss[0] - ((((160 + PApplet.parseInt(atackDamage[0] * 0.6f)) * (((char1[5] * 1) + 100) / 100)) / 2) - Boss[1]);
        char1St[1] -= 26;
      }
      if (skillAtackReimu[3] == true) {
        noroi = true;
    ...
    if (menuTime >= 1000 && menuTime <= 1900) {
      ...
      if (atack[1] == true) {
        text(BossSkill[0], width / 2 - textWidth(BossSkill[0]) / 2, 78);
        fill(255, 0, 0);
        text(PApplet.parseInt(atackDamage[1] / 2) - Boss[1], width / 2 + 50, dy2);
      }
      if (gard[1] == true) {
        text(a, width / 2 - textWidth(a) / 2, 78);
      }
      ...
      if (skillAtackMarisa[0] == true) {
        ...
        fill(255, 0, 0);
        text((((60 + PApplet.parseInt(atackDamage[1] * 0.5f)) * (((char2[5] * 1) + 100) / 100)) / 2) - PApplet.parseInt(Boss[1] * 0.3f), width / 2 + 50, dy2);
      }
      if (skillAtackMarisa[1] == true) {
        text(MarisaSkill[1], width / 2 - textWidth(MarisaSkill[1]) / 2, 78);
        fill(255, 0, 0);
        text((((130 + PApplet.parseInt(atackDamage[1] * 0.4f)) * (((char2[5] * 1) + 100) / 100)) / 2) - PApplet.parseInt(Boss[1] * 0.3f), width / 2 + 50, dy2);
      }
      ...
      if (skillAtackMarisa[3] == true) {
        ...
        fill(255, 0, 0);
        text((((200 + PApplet.parseInt(atackDamage[1] * 0.6f)) * (((char2[5] * 1) + 100) / 100)) / 2) - PApplet.parseInt(Boss[1] * 0.5f), width / 2 + 50, dy2);
      }
    ...
    if (menuTime >= 1500 && One4 == true) {
      if (atack[1] == true) {
        punch.trigger();
        Boss[0] = Boss[0] - (PApplet.parseInt(atackDamage[1] / 2) - Boss[1]);
      }
      if (gard[1] == true) {
        char2[3]*=2;
      }
      ...
      if (skillAtackMarisa[0] == true) {
        elect.trigger();
        Boss[0] = Boss[0] - ((((60 + PApplet.parseInt(atackDamage[1] * 0.5f)) * (((char2[5] * 1) + 100) / 100)) / 2) - PApplet.parseInt(Boss[1] * 0.3f));
        char2St[1] -= 8;
      }
      if (skillAtackMarisa[1] == true) {
        elect.trigger();
        Boss[0] = Boss[0] - ((((130 + PApplet.parseInt(atackDamage[1] * 0.4f)) * (((char2[5] * 1) + 100) / 100)) / 2) - PApplet.parseInt(Boss[1] * 0.3f));
        char2St[1] -= 16;
      }
      if (skillAtackMarisa[2] == true) {
        atackDamage[1] = 399;
      ...
      if (skillAtackMarisa[3] == true) {
        elect.trigger();
        Boss[0] = Boss[0] - ((((200 + PApplet.parseInt(atackDamage[1] * 0.6f)) * (((char2[5] * 1) + 100) / 100)) / 2) - PApplet.parseInt(Boss[1] * 0.5f));
        char2St[1] -= 18;
      }
      if (skillAtackMarisa[4] == true) {
        char2[5] = 303;
    ...
    if (menuTime >= 2000 && menuTime <= 2900) {
      ...
      if (atack[2] == true) {
        text(BossSkill[0], width / 2 - textWidth(BossSkill[0]) / 2, 78);
        fill(255, 0, 0);
        text(PApplet.parseInt(atackDamage[2] / 2) - Boss[1], width / 2 + 50, dy3);
      }
      if (gard[2] == true) {
        text(a, width / 2 - textWidth(a) / 2, 78);
      }
      ...
      if (skillAtackYoumu[3] == true) {
        ...
        fill(255, 0, 0);
        text((((160 + PApplet.parseInt(atackDamage[2] * 1)) * (((char3[5] * 1) + 100) / 100)) / 2) - PApplet.parseInt(Boss[1] * 0.5f), width / 2 + 50, dy3);
      }
    }
    if (menuTime >= 2500 && One5 == true) {
      if (atack[2] == true) {
        punch.trigger();
        Boss[0] = Boss[0] - (PApplet.parseInt(atackDamage[2] / 2) - Boss[1]);
      }
      if (gard[2] == true) {
        char3[3]*=2;
      }
      ...
      if (skillAtackYoumu[3] == true) {
        sword.trigger();
        Boss[0] = Boss[0] - ((((160 + PApplet.parseInt(atackDamage[2] * 1)) * (((char3[5] * 1) + 100) / 100)) / 2) - PApplet.parseInt(Boss[1] * 0.5f));
        char3St[1] -= 10;
      }
      One5 = false;
    }
    ...
    if (menuTime >= 3000 && menuTime <= 3500) {
      if (One2 == true) {
        int kakuritu = PApplet.parseInt(random(0, 1.9f));
        if (kamae == false) {
          if (kakuritu == 0) {
            BossSerect= PApplet.parseInt(random(0, 3.9f));
          }
          if (kakuritu == 1) {
            if (One == true &&  Boss[0] < 4000) {
              BossSerect= PApplet.parseInt(random(5.0f, 6.9f));
            }
            if (One == false) {
              BossSerect= 5;
            }
        ...
        if (kamae == true) {
          if (kakuritu == 0) {
            BossSerect= PApplet.parseInt(random(0, 4.9f));
          }
          if (kakuritu == 1) {
            if (One == true && Boss[0] < 4000) {
              BossSerect= 6;
    ...
    if (menuTime >= 3500) {
      ...
      if (BossAtack[0]  == true) {
        punch.trigger();
        int bossTarget = PApplet.parseInt(random(0, 2.9f));
      ...
      if (BossAtack[1]  == true) {
        ...
        bossTarget = PApplet.parseInt(random(0, 2.9f));
        if (bossTarget == 0) char1St[0] -= (175 - (char1[3] / 4));
        if (bossTarget == 1) char2St[0] -= (175 - (char2[3] / 4));
        if (bossTarget == 2) char3St[0] -= (175 - (char3[3] / 4));
      }
...
public void stop() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "RPG_GAME" };
    if (passedArgs != null) {
